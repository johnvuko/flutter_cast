...
class CastMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CastMessage', package: const $pb.PackageName('extensions.api.cast_channel'), createEmptyInstance: create)
    ..e<CastMessage_ProtocolVersion>(1, 'protocolVersion', $pb.PbFieldType.QE,
        defaultOrMaker: CastMessage_ProtocolVersion.CASTV2_1_0, valueOf: CastMessage_ProtocolVersion.valueOf, enumValues: CastMessage_ProtocolVersion.values)
    ..aQS(2, 'sourceId')
    ..aQS(3, 'destinationId')
    ..aQS(4, 'namespace')
    ..e<CastMessage_PayloadType>(5, 'payloadType', $pb.PbFieldType.QE,
        defaultOrMaker: CastMessage_PayloadType.STRING, valueOf: CastMessage_PayloadType.valueOf, enumValues: CastMessage_PayloadType.values)
    ..aOS(6, 'payloadUtf8')
...
class AuthChallenge extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthChallenge', package: const $pb.PackageName('extensions.api.cast_channel'), createEmptyInstance: create)..hasRequiredFields = false;
